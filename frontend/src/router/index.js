...
const routes = [
  ...
  // 主应用（共享布局：侧边栏 + 顶栏 + 内容区）
  {
    ...
    children: [
      { path: '', name: 'home-app', component: () => import('@/views/DashboardPage.vue') },
      ...
      { path: '/persons', name: 'persons', component: () => import('@/views/PeoplePage.vue') },
      { path: '/roster', name: 'roster', component: () => import('@/views/PeoplePage.vue') },
      ...
      { path: '/report', name: 'report', component: () => import('@/views/ReportListPage.vue') },
      ...
      { path: '/oj/run', name: 'oj-run', component: () => import('@/views/OjRunPage.vue') },
      ...
      { path: '/exams/:id/review', name: 'exam-review', component: () => import('@/views/ExamReviewPage.vue') },
      ...
      { path: '/question-bank', name: 'question-bank', component: () => import('@/views/QuestionBankPage.vue') },
      {
        path: '/exam-compose',
        name: 'exam-compose',
        component: () => import('@/views/exam-compose/ExamComposeLayout.vue'),
        children: [
          { path: '', name: 'exam-compose-start', component: () => import('@/views/exam-compose/StepStart.vue'), meta: { step: 0 } },
          { path: 'compose', name: 'exam-compose-compose', component: () => import('@/views/exam-compose/StepCompose.vue'), meta: { step: 1 } },
          { path: 'review', name: 'exam-compose-review', component: () => import('@/views/exam-compose/StepReview.vue'), meta: { step: 2 } },
        ],
      },
