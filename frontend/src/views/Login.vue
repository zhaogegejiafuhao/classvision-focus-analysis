      ...
      <div class="form-card">
        ...
        <div v-if="!isRegister" class="login-hint">
          ...
          <div class="hint-list">
            ...
            <span class="hint-item" :class="{ active: currentRole === 'teacher' }" @click="fillAccount('teacher', '123456')">教师</span>
            <span class="hint-item" :class="{ active: currentRole === 'student' }" @click="fillAccount('student', '123456')">学生</span>
          </div>
        </div>
      </div>
    </div>
